 ...
 *
 * A Feature object represents a spatially bounded entity. It contains a [Geometry]
 * object and additional properties.
 *
 * According to RFC 7946:
 * - A Feature object has a "type" member with the value "Feature".
 * - It must have a "geometry" member, which can be a [Geometry] object or null.
 * - It must have a "properties" member, which can be any JSON object or null.
 *
 * @property geometry The [Geometry] object associated with the feature, or null if the feature
