...
/**
 * Represents a geographical 3d point, defined by a `Coordinates` object and optional accuracy and altitude information.
 *
 * This data class is used to specify a precise location on the Earth's surface.
 *
 * @property coordinates The geographical coordinates of the point.
