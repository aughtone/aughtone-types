# Differential Testing for Arbitrary-Precision Math Types

ADR-0001 · 2026-05-23 · Status: accepted
Keywords: how do we know BigDecimal is correct, testing arbitrary precision,
          parity against the JDK, why not just unit tests, ionspin bignum as a
          test dependency, rounding edge cases, keeping test libs out of
          commonMain
