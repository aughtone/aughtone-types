# Geo Prefixing to Avoid Shadowing

ADR-0002 · 2026-06-01 · Status: accepted
Keywords: Point clashes with android.graphics.Point, why is it GeoPoint not
          Point, RFC 7946 naming, import ambiguity, why not use the RFC names
          directly, SerialName keeps the JSON compliant
