# Aughtone Types Knowledge Base

Everything a person would look up about this library: why it is shaped the
way it is, what its types promise, and how to work on it. Task-level work is
not here — that lives in GitHub Issues.
