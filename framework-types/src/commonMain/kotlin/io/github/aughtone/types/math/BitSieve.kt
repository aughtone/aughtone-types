...
import io.github.aughtone.types.math.BigInteger.Companion.valueOf
...
internal class BitSieve {
    ...
    constructor(base: BigInteger, searchLen: Int) {
        ...
        val b: MutableBigInteger = MutableBigInteger(base)
     ...
     */
    private fun get(bitIndex: Int): Boolean {
    ...
    fun retrieve(initValue: BigInteger, certainty: Int, random: Random): BigInteger? {
        ...
        for (i in bits!!.indices) {
            ...
            // for (j in 0..63) {
            (0..63).forEach { j ->
                if ((nextLong and 1L) == 1L) {
                    val candidate = initValue.add(
                        valueOf(offset.toLong())
                    )
